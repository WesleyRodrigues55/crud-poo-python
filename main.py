...
while count > 0:
    ...
    # CLASSE AGÊNCIA
        ...
        agencias.attDados(agencias.nome)
    ...
    # CLASSE TIPO DE CONTA
        ...
        tipo_de_contas.extrato = input("Digite o extrato ser cadastrado: ")
        ...
        tipo_de_contas.extrato = input("Digite o extrato ser Editado: ")
        tipo_de_contas.attDados(tipo_de_contas.codigo_agencia, tipo_de_contas.tipo_de_conta, tipo_de_contas.saldo, tipo_de_contas.extrato)
